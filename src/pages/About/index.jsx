	...
	return (
		<Container>
			<Header>
				...
				>
					<h1>About Memester</h1>
					<h2>
						Memester is all about creating and sharing laughable memes for
						developers.
					</h2>
					<p>
			...
			<LazyLoadImage
				...
				effect="blur"
				src="https://ik.imagekit.io/eke/Others/memester-editor_0QJSYGfIX.webp?ik-sdk-version=javascript-1.4.3&updatedAt=1648726474107"
				width="100%"
				height="100%"
			...
			<Section id="creators">
				<div className="heading heading-creators">
					...
					<p>
						...
						<span className="highlight">Memester.</span>
					</p>
				</div>
