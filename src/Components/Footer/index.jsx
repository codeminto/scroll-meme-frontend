...
function Footer({ scrollPosition }) {
	return (
		<Container>
			{/* <Content>
				<Social>
					...
					<Icons>
						...
						<div>
							...
							<a
								href="https://github.com/Evavic44/memester"
								title="GitHub"
								aria-label="GitHub"
							>
							...
							<a
								href="https://eke.hashnode.dev/memester-a-meme-library-and-editor-for-creating-and-sharing-memes"
								title="Hashnode"
								aria-label="Hashnode"
							>
				...
				<FooterLink>
					...
					<div className="footer-resources">
						<h3>Resources</h3>
						<a href="https://github.com/Evavic44/memester/blob/main/LICENSE">
							License
						</a>
						<a href="https://github.com/Evavic44/memester/blob/main/CODE_OF_CONDUCT.md">
							Code of Conduct
						</a>
						<a href="https://github.com/Evavic44/memester/blob/main/README.md">
							Docs
						</a>
					</div>
					...
					<div className="footer-contribute">
						<h3>Developer</h3>
						<a href="https://github.com/Evavic44/memester">Docs</a>
						<a href="https://rocketteam.gitbook.io/memester-api/">API</a>
					</div>
				</FooterLink>
			</Content> */}
			...
			<Masthead>
				<small>
					Built with <i className="fas fa-heart highlight"></i> in India
				</small>
			</Masthead>
		</Container>
	);
